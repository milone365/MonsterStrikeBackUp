...
public class Wind : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StageManager.instance.pcTurn.per_start_action_List.Add(ACTION);
    ...
    public void ACTION()
    {
        StageManager.instance.pcTurn.TIME = activationTime;
        actionCounter--;
        if(actionCounter<=0)
        {
            actionCounter = actionTurn;
    ...
    {
        StageManager.instance.pcTurn.per_start_action_List.Remove(ACTION);
    }
}
