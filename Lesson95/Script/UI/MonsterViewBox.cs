...
public class MonsterViewBox : MonoBehaviour
{
    ...
    {
        numParent.gameObject.SetActive(false);
    }
    public void InitQuest(QuestData quest,QuestSlot slot)
    {
        this.slot = slot;
        if (button == null)
        {
        ...
        button.onClick.AddListener(QuestAction);
        MonsterImage.sprite = quest.questImage;
    }
